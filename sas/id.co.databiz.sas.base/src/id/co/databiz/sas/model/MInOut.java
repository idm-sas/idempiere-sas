...
public class MInOut extends org.compiere.model.MInOut implements DocAction
{
	 ...
	 */
	public static MInOut copyFrom (MInOut from, Timestamp dateDoc, Timestamp dateAcct,
		int C_DocType_ID, boolean isSOTrx, boolean counter, String trxName, boolean setOrder, String documentNo)
	{
...
//			line.setQtyOverReceipt(fromLine.getQtyOverReceipt());
	...
	protected boolean beforeSave (boolean newRecord)
	{
        ...
        // SAS-129 There is a requirement to have shipment without order
	...
	public String completeIt()
	{
		...
		for (int lineIndex = 0; lineIndex < lines.length; lineIndex++)
		{
				...
				&& product.isStocked() )
			{
				...
				if(!isReversal() ||
						getC_DocType_ID() == SASSystemID.DOCTYPE_SHIPMENT_SCN || 
						getC_DocType_ID() == SASSystemID.DOCTYPE_SHIPMENT_SCT)
				{
...
//			counterLine.setClientOrg(counter);
	...
	protected MInOut reverse(boolean accrual) {
		...
		MInOut reversal = copyFrom (this, reversalMovementDate, reversalDate,
			getC_DocType_ID(), isSOTrx(), false, get_TrxName(), true, getDocumentNo()+"^");
		if (reversal == null)
		{
