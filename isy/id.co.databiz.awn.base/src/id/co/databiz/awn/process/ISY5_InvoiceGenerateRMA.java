 ...
 */
public class ISY5_InvoiceGenerateRMA extends SvrProcess
{
    /** Manual Selection        */
    ...
    private MInvoice createInvoice(MRMA rma)
    {
        ...
        int AD_OrgTrx_ID = rma.get_ValueAsInt("AD_OrgTrx_ID");
        ...
        //ISY-5 set orgtrx from RMA
        if (AD_OrgTrx_ID > 0)
        	invoice.setAD_OrgTrx_ID(AD_OrgTrx_ID);
        if (!invoice.save())
        {
