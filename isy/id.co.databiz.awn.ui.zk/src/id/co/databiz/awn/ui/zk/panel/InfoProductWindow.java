...
public class InfoProductWindow extends InfoWindow {
	...
	protected void renderContentPane(Center center) {
		ColumnInfo[] s_layoutWarehouse = new ColumnInfo[]{
				...
				new ColumnInfo(Msg.translate(Env.getCtx(), "QtyOrdered"), "bomQtyOrdered(M_PRODUCT_STOCK_V.M_Product_ID,M_PRODUCT_STOCK_V.M_Warehouse_ID,0) AS QtyOrdered", Double.class)};
		...
		m_sqlWarehouse += " GROUP BY Warehouse, QtyOrdered";		
