...
*/
			...
			//pshepetko msg<
			Messagebox.show(Msg.getMsg(Env.getCtx(), "Update "+new Timestamp(System.currentTimeMillis())+""), 
...
//			setToDeliverQty(getOpenQty()); //reset toDeliverQty to openQty
			setToDeliverQty(Env.ZERO); // MRI-47 set to zero
