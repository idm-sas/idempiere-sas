...
public class InvoiceGen extends GenForm
{
	...
	private String getRMASql()
	{
		...
		//Patched IDEMPIERE-4384
		sql.append("AND EXISTS (SELECT 1 FROM m_rmaline rl WHERE rl.m_rma_id = rma.m_rma_id ");
		sql.append("AND iol.m_inoutline_id = rl.m_inoutline_id AND rl.m_inoutline_id IS NOT null)) ");
