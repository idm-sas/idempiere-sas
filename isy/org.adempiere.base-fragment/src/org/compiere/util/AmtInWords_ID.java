...
public class AmtInWords_ID implements AmtInWords
{
  ...
  private static final long POWER_FIFTEEN = 1000000000000000L;
	...
	private static CLogger	s_log	= CLogger.getCLogger (AmtInWords_ID.class);
  ...
  throws IllegalArgumentException {
   ...
   static void saySimpleNumber(StringBuffer appendTo, int number) {
	...
	public String getAmtInWords (String amount) throws Exception
	{
		...
		//20100224 ~dar~ iCon int pos = amount.lastIndexOf ('.');
		int pos = amount.lastIndexOf (",");
		
		String oldamt = amount;
		//20100224 ~dar~ iCon amount = amount.replaceAll (",", "");
		//	20111019 ~dar~
		int pos1 = amount.lastIndexOf(".");
		if( pos1 > pos ) {
			pos = pos1;
	...
	{
		AmtInWords_ID aiw = new AmtInWords_ID();
        aiw.print ("0.00");		
        aiw.print ("0.23");
