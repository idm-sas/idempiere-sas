...
public class DefaultRoutingServiceImpl implements RoutingService
{
	...
	public BigDecimal estimateWorkingTime(I_PP_Cost_Collector_Libero cc)
	{
	 ...
	 * @reeturn duration
	 */
	protected BigDecimal calculateDuration(I_AD_WF_Node node, I_PP_Cost_Collector_Libero cc)
	{
		if (node == null)
		{
	...
	public BigDecimal calculateDuration(I_PP_Cost_Collector_Libero cc)
	{
	...
	public BigDecimal getResourceBaseValue(int S_Resource_ID, I_PP_Cost_Collector cc) {
		return getResourceBaseValue(S_Resource_ID, null, (I_PP_Cost_Collector_Libero) cc);
	}
	@Override
	public BigDecimal getResourceBaseValue(int S_Resource_ID, I_PP_Cost_Collector_Libero cc)
	{
	...
	protected BigDecimal getResourceBaseValue(int S_Resource_ID, I_AD_WF_Node node, I_PP_Cost_Collector_Libero cc)
	{
		if (node == null)
			node = cc.getPP_Order_Node().getAD_WF_Node();
	...
	protected I_AD_WF_Node getAD_WF_Node(I_PP_Cost_Collector_Libero cc)
	{
